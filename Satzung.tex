...
% ref zeigt nur §4 anstatt Section §4
\addto\extrasngerman{\def\sectionrefname{}}
...
\begin{enumerate}
  ...
  \begin {enumerate}
    \item \nameref{sec:Kündigung} (\ref{sec:Kündigung}),
    ...
    \item \nameref{sec:Ausschluss} (\ref{sec:Ausschluss}).
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item \nameref{sec:Mehrheitserfordernisse} für Abstimmungen sind in \ref{sec:Mehrheitserfordernisse} definiert.
